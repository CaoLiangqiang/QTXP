...
（本地 `宣传图/`，因开发商版权不入库），读图能力当时不可用，于是改用
`.build/blender/extract_palette.py`：把每张图降采样成 6×9 空间网格与 40×40 细网格
直接读 RGB，再按亮度/饱和度分层，据此判断页面内容并取色。

| 素材 | 判据 | 内容 | 采到的关键色 |
| --- | --- | --- | --- |
| IMG_1887 | 顶部蓝天渐变占 9.1%，中右为暗蓝灰 | 主立面效果图 | 玻璃 `#4d545b` `#485057` `#56626f` |
| IMG_1888 | 通篇暖褐、几乎无蓝天 | 暖调页 | 立面 `#d3bfa5` `#bfb09c`，深石材 `#8c7055` |
| IMG_1889 | 27% 为绿色调 | 景观页 | 绿化 `#487858` `#386848`，铺装 `#ae9971` |
